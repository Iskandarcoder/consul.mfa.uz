                ...
                <legend>Адрес проживания зарубежом:</legend>
                    ...
                    <p class="p2">
                    <label for="strana" ><font style="color:red;">*</font>&nbsp;Страна проживания</label>
		    ...
		    <label for="kun" ><font style="color:red;">*</font>&nbsp;Дата прибытия:</label>
		      <input name="kelDay" maxlength="10" type="text" id="kelDay" class="error" value="" />
                    ...
                    <div class="sub1"><sub>(регион, город, улица, дом, квартира, телефон, e-mail)</sub>
                           ...
                           <div class="p4" >
                    <label for="vr_adress" >Принятие иностанного гражданство:</label>
                 <select id="f_davlat" name="f_davlat"   onclick = "InstNext(this)"/>
           <?php
               echo '<option selected="selected" value="-1" > </option>';
              		 $select = mysql_query("SELECT sp_name01, sp_id FROM sp_country  order by 1");      //Davlatlar
	    		     while(list($sp_name01,$sp_id) = mysql_fetch_row($select))
   ...
   <br/>
          <p class="p7"> 
          <label><font style="color:red;">*</font>&nbsp;Место поставки на учет:</label> 
