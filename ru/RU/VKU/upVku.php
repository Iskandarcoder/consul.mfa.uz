...
$upload_Mal = null;
      $guid         =guid();
$uploaddir = $_SERVER['DOCUMENT_ROOT'].'./RU/upload/';
...
if ($p!='')
 ...
 $millat =  $millat.iconv("UTF-8","CP1251", trim(stName('sp_nation',$nationality_id)));
  	 $pos = strpos($millat,'/');  
...
//$living_uzb_place = iconv("UTF-8","CP1251", $living_uzb_place);	 
$living_uzb_place=wordwrap($living_uzb_place,300,"\n");
	 $pdf->SetXY(360,380);
	 $pdf-> MultiCell(200,12, iconv("UTF-8","CP1251",$living_uzb_place));	 

$living_foreign_place = iconv("UTF-8","CP1251", $living_foreign_place);	
