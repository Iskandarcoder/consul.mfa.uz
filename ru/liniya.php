...
<h3>В данной странице Вы можете сообщить Консульской службе Республики Узбекистан <br/>о своих <span>проблемах,</span> возникших в стране проживания. </h3>
<div class="mydiv">
		  <form id="form1"  name="form1" method="post" >
	            <p>
		      <label>Сообщите о проблемах, с которыми Вы столкнулись за рубежом<br/>
 ...
 <label for="c1"><span class="class_span"></span> - Я, не робот</label>	
  ...
  <br /> 
             <p>
		      <label>
		      <input  id="yuborish"   type="button" name="Submit" value="Отправка">
		      </label>
		    </p>
 ...
 <script type="text/javascript">
  $(document).ready(function($)     
   ...
   function showRequest() { 
      if(textarea.val()=='')  {
      	 MyAlert("Введите информацию о проблемах!",'Ошибка');
      	 return false;
      	};
      	  if(fio.val()=='')  {
      	 MyAlert("Введите фамилия, имя и отчество !",'Ошибка');
      	 return false;
      	};
    	  if(davlat.val()=='')  {
      	 MyAlert("Введите страну пребывания!",'Ошибка');
      	 return false;
      	};
 	  if(manzil.val()=='')  {
      	 MyAlert("Введите адрес проживания!",'Ошибка');
      	 return false;
      	};
     ...
     {
  	MyAlert("Введите правильно адрес Email !",'Ошибка');
      	 return false;
    }
