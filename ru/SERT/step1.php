                ...
                <p class="p1">
                 ...
                 <p class="p1" >
                    ...
                    <p class="p1" ">
                    <label for="nation" > <font style="color:red;">*</font>&nbsp;Национальность</label>
                      <?php
        ...
        <p class="p1">
           <label for="jins"> <font style="color:red;">*&nbsp</font>Пол</label>
 ...
 ?>
        ...
        <p class="p1">
	   <label for="oila"><font style="color:red;">*</font>Семейное пол.</label>
