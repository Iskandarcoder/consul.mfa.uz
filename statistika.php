...
?>
 ...
 <div id="wrapper">   
<h1>Konsullik interaktiv xizmatlarini monitoringi va statistika ma'lumotlari <br/>(2017 y.)</h1>
<h2>Umumiy kirishlar soni:  <span></span></h2>
 <h3>Umumiy ko`rishlar soni:  <span></span></h3>
...
<thead class="fixedHeader">
	<tr class="alternateRow">
	 	<th><a href="#">№</a></th>
		<th><a href="#">Harakat turlari</a></th>
		<th><a href="#">Soni</a></th>
		<th><a href="#">%  (ko`rishga nisbatan)</a></th>
	</tr>
</thead>
<tbody class="scrollContent">
	...
	<tr class="normalRow" >
		<td>1.</td>
		<td> &nbsp; Sertifikat olish uchun murojaatlar</td>
		<td id="tr1td3">50</td>
		<td id="tr1td4"></td>
	</tr>
		<tr class="alternateRow">
		<td>2.</td>
		<td> &nbsp; Doimiy konsullik hisobiga turish uchun murojaatlar</td>
		<td id="tr2td3"></td>
		<td id="tr2td4"></td>
	</tr>
		<tr class="normalRow">
		<td>3.</td>
		<td> &nbsp; Vaqtincha konsullik hisobiga turish uchun murojaatlar</td>
		<td id="tr3td3"></td>
		<td id="tr3td4"></td>
	</tr>
			<tr class="alternateRow">
		<td>4.</td>
		<td> &nbsp; Reyting bahosini berganlar</td>
	        <td id="tr4td3"></td>
		<td id="tr4td4"></td>
	</tr>
			<tr class="normalRow">
		<td>5.</td>
		<td> &nbsp; Izoh qoldirganlar</td>
		<td id="tr5td3"></td>
		<td id="tr5td4"></td>
	</tr>
			<tr class="alternateRow">
		<td>6.</td>
		<td> &nbsp; So`rovnomada ovoz berganlar</td>
		<td id="tr6td3"></td>
		<td id="tr6td4"></td>
	</tr>
			<tr class="normalRow">
		<td>7.</td>
		<td> &nbsp; Ro`yxatdan o`tganlar</td>
		<td id="tr7td3"></td>
		<td id="tr7td4"></td>
	</tr>
			<tr class="alternateRow">
		<td>8.</td>
		<td> &nbsp; Online murojaat qilganlar</td>
		<td id="tr8td3"></td>
		<td id="tr8td4"></td>
	</tr>
</tbody>
      ...
      $(document).ready(function($)     
   {
	 ...
	 $.ajax({
  	...
  	/*
   	  if($('#ses_name').val()=='')
	  {
 MyAlert("Ro`yxatdan o`tgan foydalanuvchilarga ko`rish ruxsat etiladi!","Eslatma");
 setTimeout(function(){
	  window.history.back();
             return true;
},3000); 
   ...
   function showResponse(res){
       ...
       $('h3 span').text($data.views);
        ...
        //var s1 = [$data.sert, $data.pku, $data.vku, $data.c,$data.izoh,$data.opros,$data.klients,$data.muammo];
