...
<input  id="ses_name" type="hidden"  value = "<?php  echo $_SESSION['login'];?>" />
     ...
     <h2 >O`zbekiston Respublikasining horijda <span>doimiy yashovchi fuqarolarini </span>ro`yhatga olish uchun shaxsiy ma'lumotlarni kiritish</h2>
            <br/>
     <div id="wrapper1">
...
<label for="tab-4" id="tab-label-4">O`zbekistonda yashagan joyi </label>
...
$('#RO_eslat').click(function(e){
	  if($('#ses_name').val()=='')
	  MyAlert("Ro`yhatdan o`tgan foydalanuvchilarga izoh qoldirish ruhsat etiladi!","Eslatma");
          // else
