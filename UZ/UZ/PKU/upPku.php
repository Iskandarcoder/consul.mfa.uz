...
// 1-ch tab
 ...
 $other_citizenship_id         =$_POST["f_davlat"];
  $pos = strpos($other_citizenship_id,'/');  
   if($pos != false)     $other_citizenship_id = substr($other_citizenship_id,0,$pos); 
...
$consular_account_type =0;
 /////////
  ...
  $date_begin_document       = ToMysqlDate($date_begin_document);
   ...
   $lSQL=$lSQL." values ('".$guid."',  '".$division_id."',  '".$surname_cyrillic."',  '".$name_cyrillic."',  '".$patronym_cyrillic."',
