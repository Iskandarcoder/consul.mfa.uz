...
<h5>O`zbekiston Respublikasi dsadsadfsafsafuqarolari uchun interaktiv xizmatlar: </h5>
<div class="k-uslugi">
...
<div class="col-sm-3">
  ...
  <div class="col-sm-3">
    <a href="?action=smrt">
      <button type="button" class="btn btn-labeled btn-lg btn-info">
        <span class="btn-label"><i class="fa fa-2x fa-bed"></i></span>O`lim</br>haqidagi</br>guvohnoma
        <div class="overlay">
          <div class="text">Hello World</div>
        </div>
      </button>
