...
if(($p_district == 0)||($p_district == null))
		...
		'".addslashes($p_address)."', '".$p_marital."', '".$p_countryout."', '".$p_addressout."', '".$p_cause."', 
...
//
  ...
  //
  $pdf->setSourceFile('../SERT/Anketa_lat.pdf');
...
if($p_regionb>0)
 ...
 $millat =  iconv("UTF-8","CP1251", trim(stName('sp_nation',$p_nation)));
