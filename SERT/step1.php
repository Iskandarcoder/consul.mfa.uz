 ...
 ?>
        ...
        <p class="p1">
	   <label for="oila"><font style="color:red;">*</font>Oilaviy ahvoli</label>
...
<?php    $select = mysql_query("SELECT sp_name04, sp_id FROM sp_marital") or die(mysql_error());
   ...
   <!--
     ...
     <div class="photo">
     <div>Surat...</div>
        <input  size="1" class="fileupl" type="file" name="fileToUpload" id="fileToUpload"  onchange="ajaxUpload(this.form,'photo_upload.php', ''); return false;"/>
    </div>
         </div>
-->
