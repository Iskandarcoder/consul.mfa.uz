...
if ($p!='')
 $pdf->Image($p, 162, 31, 35, 43);
   ...
   $pdf->Text1($_value['fam'],12,39,0);
   $pdf->Cell(75,15,"",'1',0,'C');
   $pdf->Text1("Previous Surname",86,34,1);
   $pdf->Text1($_value['prejfam'],86,39,0);
   $pdf->Cell(40,15,"",'L,T,R',1,'C');
   $pdf->Cell(75,15,"",'1',0,'C');
   $pdf->Text1("First Name",12,49,1);
   $pdf->Text1($_value['ism'],12,54,0);
   $pdf->Cell(75,15,"",'1',0,'C');
   $pdf->Text1("Previous First Name",86,49,1);
   $pdf->Text1($_value['prejfam'],86,54,0);
   $pdf->Cell(40,15,"",'L,R',1,'C');
   $pdf->Cell(75,15,"",'1',0,'C');
   $pdf->Text1("Other Names",12,64,1);
   $pdf->Text1($_value['sharif'],12,69,0);
   $pdf->Cell(75,15,"",'1',0,'C');
   $pdf->Text1("Previous Other Names",86,64,1);
   $pdf->Text1($_value['prejsharif'],86,69,0);
   $pdf->Cell(40,15,"",'L,B,R',1,'C');

   $pdf->Cell(30,15,"",'1',0,'L');
   $pdf->Text1("Date if Birth",12,79,1);
...
//   $fuqaro=$fuqaro;
   ...
   $pdf->Text1("Previous Citizenship",159,79,1);

   $pdf->Text1($prejfuqaro,159,84,0);

   $pdf->Cell(30,15,"",'1',0,'L');
   $pdf->Text1("Passport Type",12,94,1);
$tip=$_value['tip'];
if(strlen($tip)>12)$tip=Substr($tip,0,12);
  $pdf->Text1($tip,12,99,0);
   $pdf->Cell(32,15,"",'1',0,'L');
   $pdf->Text1("Passport Number",42,94,1);
$nomer=$_value['nomer'];
   $pdf->Text1($nomer,42,99,0);
   $pdf->Cell(40,15,"",'1',0,'L');
   $pdf->Text1("Date of Issue",75,94,1);
...
/*  $jobadres=iconv("UTF-8","CP1251",$_value['jobadres']);
  ...
  */
  ...
  $fio_deti=$_value['fio_deti'];
   ...
   $pdf->Text1("Providing false information may cause the denial of visa",12,251,1);

   $pdf->Cell(124,4,"For official use only",'1',0,'L');
   $pdf->Cell(66,4,"",'L,T,R',1,'L');
   $pdf->SetFontSize(5);
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Qayd ¹",11,259,0);
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Blank ¹",42,259,0);
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Tasdiq ¹",73,259,0);
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Visa turi",104,259,0);
   $pdf->Cell(66,9,"",'L,R',1,'L');
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Berilgan sana",11,268,0);
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Muddati",42,268,0);
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Tushum",73,268,0);
   $pdf->Cell(31,9,"",'1',0,'L');
$pdf->Text4("Xaqiqiy xarajat",104,268,0);
...
//   $fuqaro=iconv("UTF-8","CP1251",$fuqaro);
 ...
 $pdf->Cell(192,11,"",'1',1,'L');
   ...
   $pdf->Cell(192,11,"",'1',1,'L');
   $pdf->Text2("Purpose of visit",12,$my+65,1);
   $maqsad=$_value['maqsad'];
