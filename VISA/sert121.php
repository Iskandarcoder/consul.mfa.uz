        ...
        <div id="content">
         ...
         <div id="steps">
             <form id="formElem" name="formElem" action="" method="post">
                <fieldset class="step">
<p class="sh1">Персональная информация (только английскими буквами)</p>
			 <div class="block2" >
                    <p class="sh1">
...
<p class="sh1">Паспортные данные</p>
...
<p class="sh1">Информация о поездке</p>
                  <br>
<p class="sh1">
...
<br><br>
     ...
     <p class="sh4" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;При надлежащем заполнении анкеты, каждая страничка отмечается (<img src="images/checked.png">)зеленой галочкой в углу.<br>
