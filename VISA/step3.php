...
<tr>
<td class="legend" colspan=4 style="text-align: left"><label class="mandatory_label1" for="goroda">Route of transiting through the territory of Uzbekistan (choose from the following list no more than 5 points):</label></td>
 <td colspan="3"><textarea class="enru123" name="goroda" maxlength="60" id="goroda" rows="2" cols=60 style="width: 100%; height: 24px; display: none;"></textarea></td>
</tr>
<tr>
<td class="legend"><label class="goroda_label" for="goroda"></label></td>
<td colspan="3">
<!-- <div class="container"> -->
    <div class="form-group">
        <select id="ms" multiple="multiple">
            <option value="TAS">Tashkent</option>
            <option value="TOV">Tashkent region</option>
            <option value="SIR">Sirdarya</option>
            <option value="JIZ">Jizzak</option>
            <option value="SAM">Samarkand</option>
            <option value="BUH">Bukhara</option>
            <option value="NAV">Navoi</option>
            <option value="AND">Andijan</option>
            <option value="NAM">Namangan</option>
            <option value="FAR">Fergana</option>
            <option value="XOR">Khorezm</option>
			<option value="SUR">Surkhandarya</option>
			<option value="QAS">Kashkadarya</option>
		    <option value="QOR">Karakalpakstan</option>
        </select>
    </div>
<!--</div> -->
<span class="remark_label">(press and select from the list)</span>
</td>
</tr>
<tr>
<td class="legend"><label class="mandatory_label" for="maqsad">Purpose of Visit <br>(in detail)</label></td>
<td colspan="3"><textarea class="mandatory en123" name="maqsad" maxlength="200" id="maqsad" rows="1" cols=76></textarea> </td>
</tr><tr>
<td class="legend"><label class="mandatory_label" for="taklifchi">Inviting Party</label></td>
<td colspan="3"><textarea class="mandatory en123" id="taklifchi" name="taklifchi" maxlength="200" rows="1" cols=76 ></textarea><span class="remark_label">(inviting organization or person, phone)</span></td></td>
</tr>
</table>
</div>
</div>
<div id="sel-values" name="sel-values" style="display: none;"></div>

<script>
    $(function() {
        $('#ms').change(function() {
            console.log($(this).val());
            $('#goroda').text($(this).val());
