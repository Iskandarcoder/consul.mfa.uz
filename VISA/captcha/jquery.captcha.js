;(function( $ ){
	...
	var defaults = {
	   ...
	   formId: "formElem",
	   text: "Для проверки человечности,<br />перетащите<span>ножница</span><br/> внутрь круга.",
	   items: Array("карандаш", "ножница", "часы", "сердце", "нота")
	  };
	...
	$("#ajax-fc-circle").droppable({
		drop: function(event, ui) {
			...
			$("#" + options.formId).append("<input type=\"hidden\" id=\"captcha\" style=\"display: none;\"  name=\"captcha\" value=\"" + rand + "\">");
		},
		tolerance: 'touch'
	});
	};
